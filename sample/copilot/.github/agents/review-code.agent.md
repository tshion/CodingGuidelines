...
3. If there are any review comments, follow the steps below:
    ...
    4. Review the source code again based on the extracted detailed coding guidelines
    5. Provide feedback based on the detailed information obtained. If Japanese is requested, return the text from `textJapanese`
